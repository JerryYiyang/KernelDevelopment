...
#define KB_SC_CAPSLOCK 0x58   // Caps Lock
...
#define KB_SC_RALT      0x11  // Right Alt (extended key)
#define KB_SC_RCTRL     0x14  // Right Control (extended key)

#define KB_SC_UP        0x75  // Up arrow
#define KB_SC_LEFT      0x6B  // Left arrow
#define KB_SC_RIGHT     0x74  // Right arrow
#define KB_SC_DOWN      0x72  // Down arrow

#define KB_SC_INSERT    0x70  // Insert
#define KB_SC_DELETE    0x71  // Delete
#define KB_SC_HOME      0x6C  // Home
#define KB_SC_END       0x69  // End
#define KB_SC_PGUP      0x7D  // Page Up
#define KB_SC_PGDN      0x7A  // Page Down

#define KB_SC_NUM_LOCK  0x77  // Num Lock
#define KB_SC_KP_SLASH  0x4A  // Keypad / (extended key)
#define KB_SC_KP_STAR   0x7C  // Keypad *
#define KB_SC_KP_MINUS  0x7B  // Keypad -
#define KB_SC_KP_PLUS   0x79  // Keypad +
#define KB_SC_KP_ENTER  0x5A  // Keypad Enter (extended key)
...
#define KB_SC_PRINT_SCREEN  0x7C    // Print Screen (extended key)
...
#define KB_SC_LWIN      0x1F  // Left Windows key (extended key)
#define KB_SC_MENU      0x2F  // Menu key (extended key)
